...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class RealtimeServerEventConversationItemCreatedItemContent {
    /// <summary>
    /// The content type (\"text\", \"audio\", \"input_text\", \"input_audio\").
    /// </summary>
    /// <value>The content type (\"text\", \"audio\", \"input_text\", \"input_audio\").</value>
    ...
    public override string ToString()  {
      ...
      sb.Append("class RealtimeServerEventConversationItemCreatedItemContent {\n");
