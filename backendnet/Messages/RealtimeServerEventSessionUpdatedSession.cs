...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class RealtimeServerEventSessionUpdatedSession {
    /// <summary>
    ...
    public OneOfRealtimeServerEventSessionUpdatedSessionMaxOutputTokens MaxOutputTokens { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class RealtimeServerEventSessionUpdatedSession {\n");
