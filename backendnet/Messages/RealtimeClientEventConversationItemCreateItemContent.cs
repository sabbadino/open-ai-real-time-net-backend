...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class RealtimeClientEventConversationItemCreateItemContent {
    /// <summary>
    /// The content type (\"input_text\", \"input_audio\", \"text\", \"audio\").
    /// </summary>
    /// <value>The content type (\"input_text\", \"input_audio\", \"text\", \"audio\").</value>
    ...
    public override string ToString()  {
      ...
      sb.Append("class RealtimeClientEventConversationItemCreateItemContent {\n");
