...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class RealtimeClientEventConversationItemCreateItem {
    /// <summary>
    ...
    /// </summary>
    /// <value>The role of the message sender (\"user\", \"assistant\", \"system\").</value>
    ...
    public List<RealtimeClientEventConversationItemCreateItemContent> Content { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class RealtimeClientEventConversationItemCreateItem {\n");
